...
public class Power
{
    ...
    /**
     ...
     Post condition: Instance variables String name and int strength are initialized with
    ...
    /**
     ...
     Post condition: Returns String name accessed from the Power object.
    ...
    /**
     ...
     Precondition: Power object must be initialized.
     Post condition: Returns int strength accessed from the Power object.
    ...
    /**
     ...
     Precondition: Power object must be initialized.
     Post condition: int strength of Power object is changed to the value of int theStrength
